---
title: "RWT-46 PRC2 IP RBRID 1x_0.1x combined data Custom Database"
...
``` {r Information}
Experiment = "RWT46"
Descriptor = "Combined_data_customdatabase" #data from both 1x and 0.1x samples searched against custom PRC2 database
Date = "18Jul2016" 
Pvaluecutoff = 0.1
MinDepletion = 0.95
...
library(gdata)
installXLSXsupport()
Prot_table <-read.xls(xls = "Robert test 1 with custom database.xlsx", sheet = 1)
...
Prot_data_combined_custom <- NormRBR(Data = Prot_table, minusCols = c(8:11), plusCols = c(12:15), pvalcutoff = Pvaluecutoff, depletionfactor = MinDepletion, cutoff = T)
